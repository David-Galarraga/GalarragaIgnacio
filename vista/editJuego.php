...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-6">
    ...
    <div class="w-full max-w-lg">
        ...
        <h1 class="text-3xl font-extrabold text-gray-800 text-center mb-6">Editar Juego</h1>
        ...
        <form method="post" action="../control/editGame.php" class="bg-white shadow-xl rounded-lg px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex items-center justify-center mb-4">
                <input type="submit" value="enviar" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer transition duration-300 ease-in-out w-full">
            </div>
        </form>
