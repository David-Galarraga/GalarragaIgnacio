<?php
    ...
    $user = new User();
    $ID = $user -> getByNickname($_POST["oldNickname"]);
    $userID = $ID["id"];

    $user->update($userID, $passCrypt, $_POST["nombre"], $_POST["apellido"], $_POST["nickname"]);
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-6">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white shadow-xl rounded-lg px-8 pt-6 pb-8 mb-4 border-t-4 border-blue-500 text-center">
            
            <p class="text-blue-600 text-2xl font-bold mb-4">Usuario actualizado.</p>
